...
public class CseActivity extends AppCompatActivity {
    ...
    private RecyclerView mCseStudentList;
    private DatabaseReference mCseDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCseDatabase = FirebaseDatabase.getInstance().getReference().child("cse/finallist");
        mCseStudentList = (RecyclerView) findViewById(R.id.recycler_view_stu_info);
        mCseStudentList.setHasFixedSize(true);
        mCseStudentList.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void update_value() {
        ...
        FirebaseRecyclerAdapter<Choose,BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Choose, BlogViewHolder>(
        ...
        {
            @Override
            protected void populateViewHolder(BlogViewHolder viewHolder, Choose model, int position) {
        ...
        mCseStudentList.setAdapter(firebaseRecyclerAdapter);
    ...
    public static class BlogViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        View mView;
        Context mContext;
        ArrayList<Choose> cse_list = new ArrayList<>();
        ...
        public void onClick(View v) {
            ...
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("cse/finallist");
            ref.addListenerForSingleValueEvent(new ValueEventListener() {

                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        cse_list.add(snapshot.getValue(Choose.class));
                    }
